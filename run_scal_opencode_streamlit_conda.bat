...
REM Usage:
REM   run_scal_opencode_streamlit_conda.bat
REM   run_scal_opencode_streamlit_conda.bat olmocr
...
python -m pip install streamlit scikit-learn joblib pypdf

echo Launching Streamlit app...
echo Open http://localhost:8501
streamlit run scal_opencode_streamlit.py
